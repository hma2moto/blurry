...
int contour_par_for_sobel__5_s0_x_xo_ti_ti(void *__user_context, int32_t _sobel__5_s0_x_xo_ti_ti, uint8_t *_closure_arg__305);
HALIDE_FUNCTION_ATTRS
int contour_par_for_countor_line__1_s0_x_xo_ti(void *__user_context, int32_t _countor_line__1_s0_x_xo_ti, uint8_t *_closure_arg__306);
HALIDE_FUNCTION_ATTRS
